    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fk_joueur1', models.ForeignKey(blank='True', null='True', on_delete=django.db.models.deletion.CASCADE, related_name='joueur1', to='tournois.joueur')),
                ('fk_joueur2', models.ForeignKey(blank='True', null='True', on_delete=django.db.models.deletion.CASCADE, related_name='joueur2', to='tournois.joueur')),
                ('fk_tournoi', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tournois.tournoi')),
            ],
        ),
        migrations.CreateModel(
